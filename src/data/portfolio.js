...
export const portfolioData = {
  ...
  projects: [
    ...
    {
      id: "project-3",
      title: "Arduino Smart Hardware System",
      description: "An embedded hardware project featuring Arduino microcontroller integration, sensor readings, motor control circuits, and C/C++ hardware logic for real-time automation.",
      techStack: ["Arduino", "C++", "C", "Hardware"],
